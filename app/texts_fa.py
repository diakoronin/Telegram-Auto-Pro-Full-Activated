...
INVOICE_CREATED = (
    "☑️ جزئیات پیش‌فاکتور شما با موفقیت ساخته شد\n\n"
    "◽️ روش پرداخت: کارت به کارت\n\n"
    "💳 شماره کارت:\n{card_number}\n\n"
    "🙎🏻‍♂️ به نام:\n{holder}\n\n"
    "🏦 بانک:\n{bank}\n\n"
    "💵 مبلغ قابل پرداخت:\n{amount} تومان\n\n"
    "🧾 شماره فاکتور:\n#{pr_id}\n\n"
    "📣 بعد از واریز، لطفاً با زدن دکمهٔ «ارسال رسید» تصویر رسید را ارسال کنید.\n\n"
    "⚠️ توجه:\n"
    "مهلت پرداخت این فاکتور {expire_minutes} دقیقه است.\n"
    "مبلغ را دقیقاً مطابق فاکتور واریز کنید.\n\n"
    "👈 برای انتقال وجه می‌توانید از همراه‌بانک، اینترنت‌بانک یا اپلیکیشن‌های معتبر استفاده کنید."
)
ASK_RECEIPT_PHOTO = (
...
PURCHASE_OK_UX = (
    ...
    "🔗 لینک سرویس شما:\n{link}\n\n"
    "⚠️ لطفاً این لینک را در جای امن نگهداری کنید.\n"
    "در صورت بروز مشکل، از بخش پشتیبانی پیام دهید."
)
