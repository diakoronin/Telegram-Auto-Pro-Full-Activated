...
SUPPORT_MENU_TITLE = "🎫 پشتیبانی — یکی از گزینه‌ها را انتخاب کنید:"
...
SHOP_PURCHASE_PREVIEW = (
    ...
    "سرویس از طریق پنل فعال می‌شود و لینک اشتراک ثابت ربات دریافت خواهید کرد.\n\n"
    "اگر اطلاعات درست است، «تأیید خرید» را بزنید."
)
...
PURCHASE_OK_UX_HTML = (
    ...
    "اگر لوکیشن عوض شد، فقط در برنامه گزینه Update Subscription را بزنید."
)
INVOICE_CARD_INCOMPLETE = (
    "⚠️ شماره کارت کامل در سیستم ثبت نشده؛ با پشتیبانی تماس بگیرید یا از کارت دیگری استفاده کنید."
)
INVOICE_CARD_INCOMPLETE_ADMIN = (
    "شماره کارت کامل ثبت نشده است. لطفاً کارت را از مدیریت کارت‌ها ویرایش کنید."
)
MY_SERVICES_TITLE = (
    "📦 سرویس‌های من\n\n"
    "لطفاً یکی از سرویس‌های خود را برای مشاهدهٔ جزئیات انتخاب کنید:"
)
MY_SERVICES_DETAIL_TITLE = "📦 جزئیات سرویس"
BTN_SERVICE_DETAIL = "🔍 مشاهده جزئیات"
BTN_REFRESH_SERVICE = "🔄 بروزرسانی اطلاعات"
BTN_LOCATION_CHANGE = "🌍 تغییر لوکیشن"
BTN_SUPPORT_SERVICE = "🎫 گزارش مشکل"
CARD_NUMBER_INCOMPLETE_ADMIN = "⚠️ این کارت شمارهٔ کامل ندارد؛ از ویرایش کارت، شمارهٔ ۱۶ رقمی کامل را ذخیره کنید."
CARD_ADMIN_DETAIL_NOTE = "\n\n(نمایش بالا برای ادمین است؛ فاکتور کاربر از شمارهٔ کامل ذخیره‌شده استفاده می‌کند.)"
